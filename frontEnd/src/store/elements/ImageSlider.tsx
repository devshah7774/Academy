...
export function ImageSlider({ imageUrls }: ImageSliderProps) {
  ...
  return (
    ...
    <div className="lg:hidden z-0 overflow-visible relative">
      <div className="relative items-center bg-slate-400 w-screen overflow-hidden lg:w-auto lg:mx-24" style={{ minHeight: '150px', maxHeight: '360px', aspectRatio: '19/5' }}>
        <img
    ...
    <div className="hidden lg:flex lg:justify-between items-center z-0 relative">
      ...
      <div className="relative items-center bg-slate-400 w-screen overflow-hidden lg:w-auto lg:mx-4" style={{ minHeight: '150px', maxHeight: '360px', aspectRatio: '19/5' }}>
        <img
          src={`../../../../src/assets/${imageUrls[imageIndex]}.jpg`}
          alt="cards-images"
          className="w-screen h-full object-fill z-0 relative" />
