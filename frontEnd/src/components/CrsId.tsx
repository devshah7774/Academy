...
function CrsId(){
  ...
  const [course, setCourse] = useState<CourseType>(initCrsobj);
  ...
  return<div>
    ...
    <Card variant="outlined" style={{width:230, padding: 20, minHeight:200, margin:"15px"}}>
      <div>
        ...
        <Typography variant="h4" textAlign={"center"}>{description}</Typography><br/>
        <Typography variant="h5" textAlign={"center"}>Price: {price}</Typography><br/>
        <Typography variant="h5" textAlign={"center"}>Published: {published?"true":"false"}</Typography>
